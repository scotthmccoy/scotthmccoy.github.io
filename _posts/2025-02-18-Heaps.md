Why use a heap? Well, it lets you add items to a data structure without _technically_ sorting them first and always know the largest (MaxHeap) or smallest (MinHeap) element.
